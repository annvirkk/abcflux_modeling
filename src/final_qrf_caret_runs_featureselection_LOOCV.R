...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv", sep="_"), ".rds"))
