...
for (flux in resp_vars) {
  ...
  # try out other svm approaches:
  # # rfe_fit11 = train(as.formula(paste(flux, "~", paste(Baseline_vars_1km, collapse="+"))),
  #                 trControl = traincontrol1, # rfe parameters
  #                 method="svmLinear", data=modeldata1) # super slow

  print("starting poly test")
  rfe_fit12 = train(as.formula(paste(flux, "~", paste(Baseline_vars_1km, collapse="+"))),
                    trControl = traincontrol1, # rfe parameters
                    method="svmPoly", data=modeldata1)
  print("starting svmradial test")
  
  rfe_fit13 = train(as.formula(paste(flux, "~", paste(Baseline_vars_1km, collapse="+"))),
                    trControl = traincontrol1, # rfe parameters
                    method="svmRadialSigma", data=modeldata1)
  ...
  #saveRDS(rfe_fit11, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "predictors_theory", "1km_svm_svmlinear",  sep="_"), ".rds"))
  saveRDS(rfe_fit12, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "predictors_theory", "1km_svm_svmpoly",  sep="_"), ".rds"))
  saveRDS(rfe_fit13, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "predictors_theory", "1km_svm_svmradialsigma",  sep="_"), ".rds"))
