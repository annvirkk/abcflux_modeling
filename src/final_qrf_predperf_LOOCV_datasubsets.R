  ...
  for (km in kms) {
    ...
    for (m in models) {
      ...
      for (v in versions) {
        ...
        if (v=="full_model_without_vegtype") {
        ...
        if (v=="full_model_without_srad") {
          
          
          
          
          Baseline_vars_1km <- c("vpd_terraclimate_sites", "pr_terraclimate_sites", "pdsi_terraclimate_sites", # met
          ...
          # Variables used in 20 km spatial resolution models
          Baseline_vars_20km<- c("vpd_terraclimate_sites", "pr_terraclimate_sites", "pdsi_terraclimate_sites", "tmean_terraclimate_sites",  # tmean included because don't have LST
        ...
        setwd("/home/master/abcflux_modeling/results/figures/")
        print(p1)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_biome.png", sep="_"), width=500, height=400)
        ...
        print(p2)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_vegtype.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p3)
        dev.copy(png, paste(i, m, km, v,  v, "train_loocv_predperf_disturbance.png", sep="_"), width=600, height=400)
        dev.off()
        ...
        print(p5)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_fluxmethod.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p6)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_fluxmethoddetail.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p7)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_measfreq.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p8)
        dev.copy(png, paste(i, m, km, v, "train_loocv_predperf_outliers.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p9)
        dev.copy(png, paste(i, m,km, v, "train_loocv_predperf_months.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        p9 <- ggplot(obspred, aes(x=pred, y=obs, colour=Interval)) +
          ...
          theme_pub  + theme(legend.title=element_blank())  + scale_colour_viridis(discrete=FALSE) + xlab(xlab) + ylab(ylab)+  
          xlim(scale_min, scale_max) + ylim(scale_min, scale_max) + facet_wrap(~Interval)
        
        print(p9)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_months_separately.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        print(p10)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_residuals.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        print(p11)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_bins.png", sep="_"), width=500, height=400)
        dev.off()
        ...
        print(p12)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_bins_country.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        print(p13)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_bins_disturbance.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        print(p11)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_modelfit_bins_country.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        print(p14)
        dev.copy(png, paste(i, m, km, v,  "train_loocv_predperf_boxplot.png", sep="_"), width=900, height=750)
        dev.off()
        ...
        # # Print out
        # setwd("/home/master/abcflux_modeling/results/figures/")
        # ggsave(paste(i, m, km, v, "train_loocv_predperf_biome.eps", sep="_"), device=cairo_ps, p1, width=16, height=11, units=c("cm"))
        # 
        # 
        # 
        # 
        ...
        # # Print out
        # setwd("/home/master/abcflux_modeling/results/figures/")
        # ggsave(paste(i, m, km, v, "train_loocv_predperf_disturbance.eps", sep="_"), device=cairo_ps, p1, width=17, height=11, units=c("cm"))
        # 
        # 
        # 
        # 
        ...
        # # Print out
        # setwd("/home/master/abcflux_modeling/results/figures/")
        # ggsave(paste(i, m, km, v, "train_loocv_predperf_months.eps", sep="_"), device=cairo_ps, p1, width=15, height=11, units=c("cm"))
        ...
        dev.copy(png, paste( i, km, v,  "qrf_vip.png", sep="_"), width=1300, height=1100)
        dev.off()
        ...
        # Print out
        setwd("/home/master/abcflux_modeling/results/figures/")
        ggsave(paste( i, km, v,  "qrf_vip.eps", sep="_"), device=cairo_ps, p1, width=35, height=23, units=c("cm"))
        
        
        write.csv(all_varImp, paste("/home/master/abcflux_modeling/results/", i, km, v, "qrf_vip.csv", sep="_"), row.names=FALSE)
...
for (i in resp_vars) {
  ...
  for (km in kms) {
    ...
    # models
    mod <- readRDS(paste0("/home/master/abcflux_modeling/results/", paste(i,  km, "qrf_train_loocv", v, sep="_"), ".rds"))
    ...
    for (nvar in 1:nvars) {
      ...
      dev.copy(png, paste( i, km, v,  Selected_vars[nvar],  "qrf_pdp.png", sep="_"), width=600, height=400)
      print(pdp_plot1)
      dev.off()
