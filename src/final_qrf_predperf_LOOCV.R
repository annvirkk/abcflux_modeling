...
for (i in resp_vars) {
  ...
  for (km in kms) {
    ...
    for (m in models) {
      ...
      print(p3)
      dev.copy(png, paste(i, m, km,"train_loocv_predperf_disturbance.png", sep="_"), width=600, height=400)
      dev.off()
      ...
      print(p5)
      dev.copy(png, paste(i, m, km,"train_loocv_predperf_fluxmethod.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p6)
      dev.copy(png, paste(i, m, km,"train_loocv_predperf_fluxmethoddetail.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p7)
      dev.copy(png, paste(i, m, km,"train_loocv_predperf_measfreq.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p8)
      dev.copy(png, paste(i, m, km,"train_loocv_predperf_outliers.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p9)
      dev.copy(png, paste(i, m,km, "train_loocv_predperf_months.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p9)
      dev.copy(png, paste(i, m, km, "train_loocv_predperf_months_separately.png", sep="_"), width=900, height=750)
      dev.off()
      ...
      print(p10)
      dev.copy(png, paste(i, m, km, "train_loocv_predperf_residuals.png", sep="_"), width=900, height=750)
      dev.off()
      ...
      print(p11)
      dev.copy(png, paste(i, m, km, "train_loocv_predperf_bins.png", sep="_"), width=500, height=400)
      dev.off()
      ...
      print(p12)
      dev.copy(png, paste(i, m, km, "train_loocv_predperf_bins_country.png", sep="_"), width=900, height=750)
      dev.off()
      ...
      print(p11)
      dev.copy(png, paste(i, m, km, "train_loocv_modelfit_bins_country.png", sep="_"), width=900, height=750)
      dev.off()
