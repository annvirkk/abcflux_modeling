...
### Model subsets new one - very simple!!!!!!!
...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/home/master/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_full_model_simple",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/home/master/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_full_model_simple", sep="_"), ".rds"))
