...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_full_model_without_larvaloutbreak",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_full_model_without_larvaloutbreak", sep="_"), ".rds"))
...
### Second key model: full dataset without veg type
...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_full_model_without_vegtype",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_full_model_without_vegtype", sep="_"), ".rds"))
...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_larvaloutbreak",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_larvaloutbreak", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_disturbedsites",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_disturbedsites", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusfire",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusfire", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusharvest",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusharvest", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusthermokarst",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_disturbedsites_plusthermokarst", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_without_daytimechambermeas",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_without_daytimechambermeas", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_with_econly",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_with_econly", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_with_reichsteinonly",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_with_reichsteinonly", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_nofactors_model_with_datafromallfluxes",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_nofactors_model_datafromallfluxes", sep="_"), ".rds"))
...
### Another subset: include only 10 key predictor variables
## First key subset: run model without larval outbreaks: removing only Lund_Kobbefjord_Ch because of extremely high uptake values. 
# Would like to keep L\xf3pez-Blanco_GL-NuF_tower1 because the flux values seem to make more sense (landscape average) but it does not have MODIS NDVI data -> will be dropped in 1 km model tuning too 
# Run this with the full list of predictors first
...
## List predictors for the models
# Variables used in 1 km spatial resolution models
Baseline_vars_1km <- c("srad_terraclimate_sites", "vpd_terraclimate_sites", "tmean_terraclimate_sites", 
...
# Variables used in 20 km spatial resolution models
Baseline_vars_20km <- c("srad_terraclimate_sites", "vpd_terraclimate_sites", "tmean_terraclimate_sites", 
                        
                        "Barrow_CO2_conc_Barrow_CO2conc", # atmos CO2 conc
                        
                        "Snow.cover_era5_soilmoist_temp_snow", "Soil.temperature.level.1_era5_soilmoist_temp_snow", "Volumetric.soil.water.layer.1_era5_soilmoist_temp_snow", #era5 here
                        
                        "ndvi3g_lowest_gapfilled_mean_GIMMS3g_NDVI_sites_low_quality_gapfilled", # Optical RS, dropped several because highly correlated
...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_11keypredictors_withoutlarvaloutbreak",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_11keypredictors_withoutlarvaloutbreak", sep="_"), ".rds"))
...
### Another subset: include only 10 key predictor variables and aggregate those and fluxes to annual averages (predictors) and annual cumulative fluxes (response)
...
# select and aggregate fluxes and predictors
d <- subset(d, select=c( "NEE_gC_m2", "GPP_gC_m2", "Reco_gC_m2", "Study_ID_Short", "id", "Meas_year", "Interval", "srad_terraclimate_sites", "vpd_terraclimate_sites", "tmean_terraclimate_sites", 

"Barrow_CO2_conc_Barrow_CO2conc", # atmos CO2 conc

"Snow.cover_era5_soilmoist_temp_snow", "Soil.temperature.level.1_era5_soilmoist_temp_snow", "Volumetric.soil.water.layer.1_era5_soilmoist_temp_snow", #era5 here

"NDVI_whittaker_constant_monthly_mean", "ndvi3g_lowest_gapfilled_mean_GIMMS3g_NDVI_sites_low_quality_gapfilled", # Optical RS, dropped several because highly correlated
...
d <- d %>% group_by(Study_ID_Short, Meas_year) %>% summarize(n=n(), NEE_gC_m2=sum(NEE_gC_m2), GPP_gC_m2=sum(GPP_gC_m2), Reco_gC_m2=sum(Reco_gC_m2),
                                                             srad_terraclimate_sites=mean(srad_terraclimate_sites), vpd_terraclimate_sites=mean(vpd_terraclimate_sites),
                                                             ...
                                                             Snow.cover_era5_soilmoist_temp_snow=mean(Snow.cover_era5_soilmoist_temp_snow), Soil.temperature.level.1_era5_soilmoist_temp_snow=mean(Soil.temperature.level.1_era5_soilmoist_temp_snow),
                                                             ...
                                                             dtm_cti_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m=unique(dtm_cti_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m),
                                                             ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_ESACCI_CAVM_merged=unique(ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_ESACCI_CAVM_merged),
                                                             SoilGrids_SOC_SoilGrids_SOCstock=mean(SoilGrids_SOC_SoilGrids_SOCstock)) %>% filter(n==12)
...
for (flux in resp_vars) {
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_train_loocv_11keypredictors_withoutlarvaloutbreak_annual",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("D:/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_train_loocv_11keypredictors_withoutlarvaloutbreak_annual", sep="_"), ".rds"))
