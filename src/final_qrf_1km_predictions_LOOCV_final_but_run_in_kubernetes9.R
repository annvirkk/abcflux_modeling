  ...
  if (c!=1 & c!=21 & c!=25) {
    ...
    for (km in kms) {
      ...
      if (km=="1km") {
        ...
        Number_of_days_since_fire_classes_MCD64A1_sites_cleaned <- terra::crop(Number_of_days_since_fire_classes_MCD64A1_sites_cleaned, ext(cropped_exent))
