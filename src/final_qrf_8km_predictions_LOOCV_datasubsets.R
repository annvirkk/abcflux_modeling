...
for (c in 1:nrow(crops)) { 
  ...
  for (km in kms) {
    ...
    for (t in 1:length(time)) {
      ...
      #  Mean annual air temperature C degrees, both data sets should be divided by 10 once again to get back to the original scale
