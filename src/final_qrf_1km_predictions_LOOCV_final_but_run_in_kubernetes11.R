...
# Reclassify veg type, fire and tkwp
...
## Load the crops table with raster splits
crops <- read.csv("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/prediction_crop_regions.csv")
# rows 1, 21, and 25 regions are completely NA -> skip these in the loop
...
for (c in 11:nrow(crops)) { 
  # c <- 6
  print(c)
  
  # skip subsets that don't have any predictor data
  if (c!=1 & c!=21 & c!=25) {
    ...
    for (km in kms) {
      ...
      if (km=="1km") {
        ...
        ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_ESACCI_CAVM_merged <- terra::crop(ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_ESACCI_CAVM_merged, terra::ext(crops[c,]))
        ...
        aboveground_biomass_carbon_2010_Above_belowground_biomass <- terra::crop(aboveground_biomass_carbon_2010_Above_belowground_biomass, ext(crops[c,]))
        ...
        tmean_TerraClimate_averages <- terra::crop(tmean_TerraClimate_averages, ext(crops[c,]))
        ...
        SoilGrids_SOC_SoilGrids_SOCstock <- terra::crop(SoilGrids_SOC_SoilGrids_SOCstock, ext(crops[c,]))
        ...
        dtm_rough.scale_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m <- terra::crop(dtm_rough.scale_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m, ext(crops[c,]))
        ...
        belowground_biomass_carbon_2010_Above_belowground_biomass <- terra::crop(belowground_biomass_carbon_2010_Above_belowground_biomass, ext(crops[c,]))
        ...
        BLDFIE_M_sl1_250m_ll_SoilGrids <- terra::crop(BLDFIE_M_sl1_250m_ll_SoilGrids, ext(crops[c,]))
        ...
        dtm_cti_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m <- terra::crop(dtm_cti_merit.dem_m_250m_s0..0cm_2018_v1.0_MERIT_topo_indices_250m, ext(crops[c,]))
        ...
        sol_watercontent.1500kPa_usda.3c2a1a_m_250m_b0..0cm_1950..2017_v0.1_SoilGrids_watercontent <- terra::crop(sol_watercontent.1500kPa_usda.3c2a1a_m_250m_b0..0cm_1950..2017_v0.1_SoilGrids_watercontent, ext(crops[c,]))
        ...
        ppt_TerraClimate_averages <- terra::crop(ppt_TerraClimate_averages, ext(crops[c,]))
        ...
        ndvi_trend_19812010 <- terra::crop(ndvi_trend_19812010, ext(crops[c,]))
        ...
        PHIHOX_M_sl1_250m_ll_SoilGrids <- terra::crop(PHIHOX_M_sl1_250m_ll_SoilGrids, ext(crops[c,]))
        ...
        terra_trend_19601990 <- terra::crop(terra_trend_19601990, ext(crops[c,]))
        ...
        UiO_PEX_PERPROB_5.0_20181128_2000_2016_NH_UiO_PEX_20181128_2000_2016_NH <- terra::crop(UiO_PEX_PERPROB_5.0_20181128_2000_2016_NH_UiO_PEX_20181128_2000_2016_NH, ext(crops[c,]))
        ...
        TKWP_Thermokarst <- terra::crop(TKWP_Thermokarst, ext(crops[c,]))
        ...
        TKHP_Thermokarst <- terra::crop(TKHP_Thermokarst, ext(crops[c,]))
        ...
        forest_age_class_forest_age_sites <- terra::crop(forest_age_class_forest_age_sites, ext(crops[c,]))
        ...
        Number_of_days_since_fire_classes_MCD64A1_sites_cleaned <- terra::crop(Number_of_days_since_fire_classes_MCD64A1_sites_cleaned, ext(crops[c,]))
      ...
      for (t in 1:length(time)) {
        ...
        srad_terraclimate_sites <- terra::crop(srad_terraclimate_sites, ext(crops[c,]))
        ...
        Barrow_CO2_conc_Barrow_CO2conc <- terra::crop(Barrow_CO2_conc_Barrow_CO2conc, ext(crops[c,]))
        ...
        NDVI_whittaker_constant_monthly_mean <- terra::crop(NDVI_whittaker_constant_monthly_mean, ext(crops[c,]))
        ...
        Soil.temperature.level.1_era5_soilmoist_temp_snow <- terra::crop(Soil.temperature.level.1_era5_soilmoist_temp_snow, ext(crops[c,]))
        ...
        water_vegetation_MCD43A4_annual_water_vegetation_sites_low_quality <- terra::crop(water_vegetation_MCD43A4_annual_water_vegetation_sites_low_quality, ext(crops[c,]))
        ...
        water_ground_MCD43A4_annual_water_ground_sites_low_quality <- terra::crop(water_ground_MCD43A4_annual_water_ground_sites_low_quality, ext(crops[c,]))
        ...
        LST_Day_1km_MOD11A2v006_LST_Day_sites_low_quality <- terra::crop(LST_Day_1km_MOD11A2v006_LST_Day_sites_low_quality, ext(crops[c,]))
        ...
        vpd_terraclimate_sites <- terra::crop(vpd_terraclimate_sites, ext(crops[c,]))
        ...
        Snow.cover_era5_soilmoist_temp_snow <- terra::crop(Snow.cover_era5_soilmoist_temp_snow, ext(crops[c,]))
        ...
        Volumetric.soil.water.layer.1_era5_soilmoist_temp_snow <- terra::crop(Volumetric.soil.water.layer.1_era5_soilmoist_temp_snow, ext(crops[c,]))
        ...
        Percent_Tree_Cover_MOD44B_sites <- rast(paste0("Percent_Tree_Cover_mod44b", substr(time[t],1, 4), ".tif")) # THE FIRST LAYER!!!!
        ...
        Percent_Tree_Cover_MOD44B_sites <- terra::crop(Percent_Tree_Cover_MOD44B_sites, ext(crops[c,]))
        #Percent_Tree_Cover_MOD44B_sites <- as.data.frame(Percent_Tree_Cover_MOD44B_sites, xy=TRUE)
        
        
        Percent_NonTree_Vegetation_MOD44B_sites <- rast(paste0("Percent_Tree_Cover_mod44b", substr(time[t],1, 4), ".tif"))  # THE SECOND LAYER!!!! (non-vegetated is the third)
        ...
        Percent_NonTree_Vegetation_MOD44B_sites <- terra::crop(Percent_NonTree_Vegetation_MOD44B_sites, ext(crops[c,]))
        #Percent_NonTree_Vegetation_MOD44B_sites <- as.data.frame(Percent_NonTree_Vegetation_MOD44B_sites, xy=TRUE)
        
        Percent_NonVegetated_MOD44B_sites <- rast(paste0("Percent_Tree_Cover_mod44b", substr(time[t],1, 4), ".tif"))  # THE THIRD LAYER!!!! (non-vegetated is the third)
        ...
        Percent_NonVegetated_MOD44B_sites <- terra::crop(Percent_NonVegetated_MOD44B_sites, ext(crops[c,]))
        ...
        trend_20yrprior_terra_change_id <- terra::crop(trend_20yrprior_terra_change_id, ext(crops[c,]))
        ...
        Snow.depth_era5_soilmoist_temp_snow <- terra::crop(Snow.depth_era5_soilmoist_temp_snow, ext(crops[c,]))
        ...
        pr_terraclimate_sites <- terra::crop(pr_terraclimate_sites, ext(crops[c,]))
        ...
        pdsi_terraclimate_sites <- terra::crop(pdsi_terraclimate_sites, ext(crops[c,]))
        ...
        for (i in resp_vars) {
          ...
          for (m in models) {
            ...
            write.csv(pred_matrix, paste0("/mnt/data1/boreal/avirkkala/abcflux_modeling/predictions_1km/", paste(i,  km, m, time[t],c, "train_loocv", sep="_"), ".csv"), row.names=FALSE) 
