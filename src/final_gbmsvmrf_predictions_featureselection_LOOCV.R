...
terraOptions(memfrac=0.9, tempdir = "D:/temp") # testing a different style
...
esa <- raster("D:/Data/abcflux_modeling/masking_summary_rasters/ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_northpolelambert1km_tundraboreal_attfix.tif")
...
esa <- rast("D:/Data/abcflux_modeling/masking_summary_rasters/ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_northpolelambert1km_tundraboreal_attfix.tif")
...
for (c in 5:nrow(crops)) {
  ...
  for (km in kms) {
    ...
    if (km=="1km") {
      ...
      setwd("D:/Data/test") ### REMEMBER TO CHANGE THIS!!!
      
      ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_ESACCI_CAVM_merged <- rast("D:/Data/abcflux_modeling/masking_summary_rasters/ESACCI_cavm_general_ESAwaterfix_broadevfix_mixfix_cropfix_nowaterglacier_northpolelambert1km_tundraboreal_attfix.tif")
      ...
      NAflag(forest_age_class_forest_age_sites)<-0
...
#       	pred_rast_final <- pred_rast_final[1:nrow(pred_rast),]
        ...
        for (m in models) {
          ...
          # Load model files
          mod <- readRDS(paste0("D:/repos/abcflux_modeling/results/", paste(i,  km, m, "loocv", sep="_"), ".rds"))
          ...
          if (km=="1km") {
            ...
            writeRaster(r, paste0("D:/Data/test/", paste(i,  km, m, time[t],c, "loocv", sep="_"), ".tif"), overwrite=TRUE, datatype='INT4S', wopt=list(NAflag=NA)) 
...
# check a few files
files <- list.files("D:/Data/test/", pattern="NEE_gC_m2_1km2_gbm")
...
files <- list.files("D:/Data/test/", pattern="NEE_gC_m2_1km_gbm")

mosaic_rasters(gdalfile=files ,dst_dataset=paste0("D:/Data/test/NEE_gC_m2_1km_gbm_2002_7.tif"),of="GTiff")

r <- rast("D:/Data/test/NEE_gC_m2_1km_gbm_2002_7.tif")
r[r< -200000000] <- NA
plot(r)
NAflag(r) <- -2147483648 
writeRaster(r, ("D:/Data/test/NEE_gC_m2_1km_gbm_2002_7_naflag.tif"))
hist(values(r)/1000) # vähän turhan isoja arvoja

files <- list.files("D:/Data/test/", pattern="NEE_gC_m2_1km_rf")

mosaic_rasters(gdalfile=files ,dst_dataset=paste0("D:/Data/test/NEE_gC_m2_1km_rf_2002_7.tif"),of="GTiff")
r <- rast("D:/Data/test/NEE_gC_m2_1km_rf_2002_7.tif")
NAflag(r) <- -2147483648 
writeRaster(r, ("D:/Data/test/NEE_gC_m2_1km_rf_2002_7_naflag.tif"))
hist(values(r)/1000) # vähän turhan isoja arvoja
plot(r)


mosaic_rasters(gdalfile=files ,dst_dataset=paste0("D:/Data/test/NEE_gC_m2_1km_svm_2002_7.tif"),of="GTiff")
r <- rast("D:/Data/test/NEE_gC_m2_1km_svm_2002_7.tif")
NAflag(r) <- -2147483648 
writeRaster(r, ("D:/Data/test/NEE_gC_m2_1km_svm_2002_7_naflag.tif"))
hist(values(r)/1000) # vähän turhan isoja arvoja
plot(r)
...
#   print(y)
#   
#   # list raster stacks that will be joined
#   all_my_rasts <- files_all[grepl(y, files_all)]
#   
#   # mosaic (each raster layer will be mosaicked separately)
#   mosaic_rasters(gdalfile=all_my_rasts,dst_dataset=paste0("/mnt/data1/boreal/avirkkala/abcflux_modeling/raster_files_from_gee/merged/ndvi_", y, ".tif"),of="GTiff")
#   gdalinfo(paste0("/mnt/data1/boreal/avirkkala/abcflux_modeling/raster_files_from_gee/merged/ndvi_", y, ".tif"))
#   
#   
# }
