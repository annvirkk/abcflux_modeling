...
for (flux in resp_vars) {
  ...
  # Control parameters
  rfecontrol <- rfeControl(functions=treebagFuncs, #caret-specific rfe process functions - there are e.g. lmFuncs too that are specific to one model type
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_gbm_test_speed2", sep="_"), ".rds"))
