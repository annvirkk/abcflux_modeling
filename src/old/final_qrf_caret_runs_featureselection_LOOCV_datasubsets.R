...
install.packages("quantregForest", lib="/mnt/data1/boreal/avirkkala/packages")  
library("quantregForest", lib.loc="/mnt/data1/boreal/avirkkala/packages")  
...
for (flux in resp_vars) {
  ...
  rfe_fit = rfe(modeldata1[,Baseline_vars_1km], modeldata1[,flux],
                ...
                method="qrf") # modeling method


  print("1 km rfe and tuning done")

  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_full_model_without_larvaloutbreak",  sep="_"), ".rds"))
...
rfe_fit2 = rfe(modeldata2[,Baseline_vars_20km], modeldata2[,flux],
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_full_model_without_larvaloutbreak", sep="_"), ".rds"))
...
for (flux in resp_vars) {
  ...
  set.seed(448)
  rfe_fit = rfe(modeldata1[,Baseline_vars_1km], modeldata1[,flux],
                sizes = c(30, 25, 20, 15, 10), # a numeric vector of integers corresponding to the number of features that should be retained
                rfeControl = rfecontrol1, # rfe parameters
                method="qrf") # modeling method
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_larvaloutbreak",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_larvaloutbreak", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_disturbedsites",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_disturbedsites", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_disturbedsites_plusfire",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_disturbedsites_plusfire", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_disturbedsites_plusharvest",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_disturbedsites_plusharvest", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_disturbedsites_plusthermokarst",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_disturbedsites_plusthermokarst", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_without_daytimechambermeas",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_without_daytimechambermeas", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_with_econly",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_with_econly", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_with_reichsteinonly",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_with_reichsteinonly", sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "1km_qrf_loocv_nofactors_model_with_datafromallfluxes",  sep="_"), ".rds"))
  ...
  ### Write the model out
  saveRDS(rfe_fit2, paste0("/mnt/data1/boreal/avirkkala/repos/abcflux_modeling/results/", paste(flux, "20km_qrf_loocv_nofactors_model_datafromallfluxes", sep="_"), ".rds"))
